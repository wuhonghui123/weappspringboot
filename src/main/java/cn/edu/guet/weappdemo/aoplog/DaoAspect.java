package cn.edu.guet.weappdemo.aoplog;

import cn.edu.guet.weappdemo.util.SecurityUtils;
import cn.edu.guet.weappdemo.util.StringUtils;
...
public class DaoAspect {
    ...
    @Pointcut("execution(* cn.edu.guet.*.mapper.*.update*(..))")
    public void daoUpdate() {
    }

    @Pointcut("execution(* cn.edu.guet.*.mapper.*.insert*(..))")
